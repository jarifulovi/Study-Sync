      ...
      <div className="flex flex-1 flex-col bg-slate-100">
        <div className="flex flex-1 items-center justify-center">
          <div className="text-center">
            ...
            <h3 className="mb-2 text-xl font-semibold text-slate-900">Select a Group</h3>
            <p className="text-sm text-slate-600">Choose a group from the left to start chatting</p>
          </div>
        </div>
      </div>
    );
