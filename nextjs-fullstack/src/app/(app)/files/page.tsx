    ...
    <div className="min-h-screen bg-white p-6 pt-20 lg:pt-6">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          <button className="flex items-center justify-center gap-2 rounded-xl bg-emerald-600 px-6 py-3 font-medium text-white shadow-lg transition-all hover:bg-emerald-700 hover:shadow-xl hover:scale-105 active:scale-95 whitespace-nowrap">
